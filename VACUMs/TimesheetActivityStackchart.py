...
def main(input_schedule_csv, output_prefix):
	...
	def generateChart(datas, dates, output_prefix, aggregation):
		...
		savefig(output_prefix + '.' + aggregation + '.png', bbox_inches='tight')
	...
	if WEEKLY_OR_DAILY == 'weekly' or 'both':
		generateChart(datas, dates, output_prefix, 'weekly')
	if WEEKLY_OR_DAILY == 'daily' or 'both':
		generateChart(datas, dates, output_prefix, 'daily')
